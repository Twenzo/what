local VenyxLibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/Twenzo/what/refs/heads/main/Universal-Vehicle-Script/main/Library.lua"))()
...
discordSection:addButton(syn and "Join the Discord server" or "Copy Discord Link", function()
	...
	setclipboard("https://www.discord.com/invite/Pornhub")
end)
