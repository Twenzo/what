if PH_LOADED and not _G.PH_DEBUG then
	-- error("Pornhub Is Already Running", 0)
	return
end

pcall(function() getgenv().PH_LOADED = true end)
...
PHMouse = cloneref(Players.LocalPlayer:GetMouse())
...
-- xylex & europa
local phassets = {
	["Pornhub/assets/bindsandplugins.png"] = "rbxassetid://5147695474",
	["Pornhub/assets/close.png"] = "rbxassetid://5054663650",
	["Pornhub/assets/editaliases.png"] = "rbxassetid://5147488658",
	["Pornhub/assets/editkeybinds.png"] = "rbxassetid://129697930",
	["Pornhub/assets/edittheme.png"] = "rbxassetid://4911962991",
	["Pornhub/assets/editwaypoints.png"] = "rbxassetid://5147488592",
	["Pornhub/assets/imgstudiopluginlogo.png"] = "rbxassetid://4113050383",
	["Pornhub/assets/logo.png"] = "rbxassetid://1352543873",
	["Pornhub/assets/minimize.png"] = "rbxassetid://2406617031",
	["Pornhub/assets/pin.png"] = "rbxassetid://6234691350",
	["Pornhub/assets/reference.png"] = "rbxassetid://3523243755",
	["Pornhub/assets/settings.png"] = "rbxassetid://1204397029"
}
...
if makefolder and isfolder and writefile and isfile then
	pcall(function() -- good executor trust
		...
		for _, folder in {"Pornhub", "Pornhub/assets"} do
			if not isfolder(folder) then
				makefolder(folder)
			end
		end
		for path in phassets do
			if not isfile(path) then
				writefile(path, game:HttpGet((path:gsub("Pornhub/", assets))))
			end
		end
		if IsOnMobile then writefile("Pornhub/assets/.nomedia", "") end
	end)
end
...
Title.TextSize = 18
Title.Text = "Pornhub Premium v" .. currentVersion
...
Cmdbar.Text = ""
Cmdbar.ZIndex = 10
Cmdbar.PlaceholderText = "Cracked By ImBored449"
...
SettingsButton.Image = getcustomasset("Pornhub/assets/settings.png")
...
ReferenceButton.Image = getcustomasset("Pornhub/assets/reference.png")
...
ColorsButton = makeSettingsButton("Edit Theme",getcustomasset("Pornhub/assets/edittheme.png"))
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Edit Keybinds",getcustomasset("Pornhub/assets/editkeybinds.png"))
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Edit Aliases",getcustomasset("Pornhub/assets/editaliases.png"))
...
Positions = makeSettingsButton("Edit/Goto Waypoints",getcustomasset("Pornhub/assets/editwaypoints.png"))
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Edit Event Binds",getcustomasset("Pornhub/assets/bindsandplugins.png"),759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Manage Plugins",getcustomasset("Pornhub/assets/bindsandplugins.png"),743)
...
CloseImage.Image = getcustomasset("Pornhub/assets/close.png")
...
PinImage.ZIndex = 10
PinImage.Image = getcustomasset("Pornhub/assets/pin.png")
...
Logo.Image = getcustomasset("Pornhub/assets/logo.png")
...
ExitImage_2.Image = getcustomasset("Pornhub/assets/close.png")
...
Img.Image = getcustomasset("Pornhub/assets/imgstudiopluginlogo.png")
Img.ZIndex = 10
...
About.TextSize = 14
About.Text = "Plugins are .ph files and should be located in the 'workspace' folder of your exploit."
...
ExitImage_3.Image = getcustomasset("Pornhub/assets/close.png")
...
PluginsHint.Text = "Download plugins from the PH Discord (discord.gg/Pornhub)"
...
ExitImage_5.Image = getcustomasset("Pornhub/assets/close.png")
...
ImageLabel.Image = getcustomasset("Pornhub/assets/minimize.png")
...
ImageLabel_2.Image = getcustomasset("Pornhub/assets/close.png")
...
eventEditor = (function()
	...
	local main = create({
		...
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("Pornhub/assets/close.png"),Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{53,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("Pornhub/assets/settings.png"),Parent={52},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),ZIndex=10,}},
	})
	main.Name = randomString()
...
reference = (function()
	local main = create({
		...
		{114,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={112},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="You can join the Discord server to get support with PH,  and read up on more documentation such as the Plugin API.",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
	...
	inviteButton.MouseButton1Click:Connect(function()
		if everyClipboard then
			toClipboard("https://discord.gg/Pornhub")
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.gg/Pornhub)"
	end)
	dragGUI(main)
	main.Parent = ScaledHolder
...
function createPopup(title, text)
	...
	ExitImage.Image = getcustomasset("Pornhub/assets/close.png")
	ExitImage.ZIndex = 10
...
function saves()
	if writefileExploit() and readfileExploit() and jsonAttempts < 10 then
		local readSuccess, out = readfile("PH_FE.ph", true)
		if readSuccess then
			if out ~= nil and tostring(out):gsub("%s", "") ~= "" then
				local success, response = pcall(function()
					...
					if vtype(json.keepPH, "boolean") then KeepInfYield = json.keepPH else KeepInfYield = true end
				...
				if not success then
					...
					writefile("PH_FE.ph", defaults, true)
					wait()
					saves()
				end
			else
				writefile("PH_FE.ph", defaults, true)
				wait()
				local dReadSuccess, dOut = readfile("PH_FE.ph", true)
...
function updatesaves()
	if nosaves == false and writefileExploit() then
		...
		writefileCooldown("PH_FE.ph", HttpService:JSONEncode(update))
	end
end
...
if type(PluginsTable) == "table" then
	for i = #PluginsTable, 1, -1 do
		if string.sub(PluginsTable[i], -3) ~= ".ph" then
...
PHMouse.KeyDown:Connect(function(Key)
	if (Key==prefix) then
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- Pornhub Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
function selectPart()
	...
	local function HighlightPart()
		if selected.Adornee ~= PHMouse.Target then
			selectionBox.Adornee = PHMouse.Target
		else
			selectionBox.Adornee = nil
		end
	end
	ActivateHighlight = PHMouse.Move:Connect(HighlightPart)
	local function SelectPart()
		if PHMouse.Target ~= nil then
			selected.Adornee = PHMouse.Target
			Path.Text = getHierarchy(PHMouse.Target)
		end
	end
	ClickSelect = PHMouse.Button1Down:Connect(SelectPart)
end
...
PrefixBox:GetPropertyChangedSignal("Text"):Connect(function()
	...
	Cmdbar.PlaceholderText = "Cracked By ImBored449 ("..prefix..")"
	updatesaves()
end)
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the Pornhub discord server.'}
...
CMDs[#CMDs + 1] = {NAME = 'hidePH', DESC = 'Hides the main PH GUI'}
CMDs[#CMDs + 1] = {NAME = 'showPH / unhidePH', DESC = 'Shows PH again'}
CMDs[#CMDs + 1] = {NAME = 'keepPH', DESC = 'Auto execute PH when you teleport through servers'}
CMDs[#CMDs + 1] = {NAME = 'unkeepPH', DESC = 'Disable keepPH'}
CMDs[#CMDs + 1] = {NAME = 'togglekeepPH', DESC = 'Toggles keepPH'}
...
function checkTT()
	local t
	local guisAtPosition = COREGUI:GetGuiObjectsAtPosition(PHMouse.X, PHMouse.Y)
	...
	if t ~= nil and t:GetAttribute("Title") ~= nil then
		...
		local xP
		local yP
		if PHMouse.X > 200 then
			xP = x - 201
		else
			xP = x + 21
		end
		if PHMouse.Y > (PHMouse.ViewSizeY-96) then
			yP = y - 97
		else
			yP = y
		end
			...
			if cmd then
				...
				if infTimes then
					while lastBreakTime < cmdStartTime do
						...
						if not success and _G.PH_DEBUG then
...
local MousePositionToVector2 = function()
	return Vector2.new(PHMouse.X, PHMouse.Y)
end
...
local function clicktpFunc()
	pcall(function()
		...
		local hitPosition = PHMouse.Hit.Position
...
PHMouse.Button1Down:Connect(function()
	for i,v in pairs(binds) do
		...
		elseif v.COMMAND == 'clickdel' then
			...
			if input == 'RightClick' and UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton2) then
				pcall(function() PHMouse.Target:Destroy() end)
...
function addPlugin(name)
	if name:lower() == 'plugin file name' or name:lower() == 'ph_fe.ph' or name == 'ph_fe' then
		notify('Plugin Error','Please enter a valid plugin')
	else
		local file
		local fileName
		if name:sub(-3) == '.ph' then
			pcall(function() file = readfile(name) end)
			fileName = name
		else
			pcall(function() file = readfile(name..'.ph') end)
			fileName = name..'.ph'
		end
		if file then
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/Twenzo/what/refs/heads/main/PH.lua'))()")
	end
end)
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if everyClipboard then
		toClipboard('https://discord.com/invite/Pornhub')
		notify('Discord Invite', 'Copied to clipboard!\ndiscord.gg/Pornhub')
	else
		notify('Discord Invite', 'discord.gg/Pornhub')
	end
	if httprequest then
		httprequest({
...
addcmd('keepph', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = true
		notify('KeepPH','Pornhub will now run after you teleport')
		updatesaves()
	else
...
addcmd('unkeepph', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = false
		notify('KeepPH','Pornhub will no longer run after you teleport')
		updatesaves()
	else
		notify('Incompatible Exploit','Your exploit does not support this command (missing queue_on_teleport)')
	end
...
addcmd('togglekeepph', {}, function(args, speaker)
	if queueteleport then
...
function sFLY(vfly)
	...
	flyKeyDown = UserInputService.InputBegan:Connect(function(input, processed)
		...
		if input.KeyCode == Enum.KeyCode.W then
			CONTROL.F = (vfly and vehicleflyspeed or phflyspeed)
		elseif input.KeyCode == Enum.KeyCode.S then
			CONTROL.B = - (vfly and vehicleflyspeed or phflyspeed)
		elseif input.KeyCode == Enum.KeyCode.A then
			CONTROL.L = - (vfly and vehicleflyspeed or phflyspeed)
		elseif input.KeyCode == Enum.KeyCode.D then
			CONTROL.R = (vfly and vehicleflyspeed or phflyspeed)
		elseif input.KeyCode == Enum.KeyCode.E and QEfly then
			CONTROL.Q = (vfly and vehicleflyspeed or phflyspeed)*2
		elseif input.KeyCode == Enum.KeyCode.Q and QEfly then
			CONTROL.E = -(vfly and vehicleflyspeed or phflyspeed)*2
		end
	...
	mfly2 = RunService.RenderStepped:Connect(function()
		...
		if speaker.Character:FindFirstChildWhichIsA("Humanoid") and root and root:FindFirstChild(velocityHandlerName) and root:FindFirstChild(gyroHandlerName) then
			...
			if direction.X > 0 then
				VelocityHandler.Velocity = VelocityHandler.Velocity + camera.CFrame.RightVector * (direction.X * ((vfly and vehicleflyspeed or phflyspeed) * 50))
			end
			if direction.X < 0 then
				VelocityHandler.Velocity = VelocityHandler.Velocity + camera.CFrame.RightVector * (direction.X * ((vfly and vehicleflyspeed or phflyspeed) * 50))
			end
			if direction.Z > 0 then
				VelocityHandler.Velocity = VelocityHandler.Velocity - camera.CFrame.LookVector * (direction.Z * ((vfly and vehicleflyspeed or phflyspeed) * 50))
			end
			if direction.Z < 0 then
				VelocityHandler.Velocity = VelocityHandler.Velocity - camera.CFrame.LookVector * (direction.Z * ((vfly and vehicleflyspeed or phflyspeed) * 50))
			end
...
addcmd('float', {'platform'},function(args, speaker)
	...
	if pchar and not pchar:FindFirstChild(floatName) then
		task.spawn(function()
			...
			qUp = PHMouse.KeyUp:Connect(function(KEY)
				if KEY == 'q' then
					FloatValue = FloatValue + 0.5
				end
			end)
			eUp = PHMouse.KeyUp:Connect(function(KEY)
				if KEY == 'e' then
					FloatValue = FloatValue - 1.5
				end
			end)
			qDown = PHMouse.KeyDown:Connect(function(KEY)
				if KEY == 'q' then
					FloatValue = FloatValue - 0.5
				end
			end)
			eDown = PHMouse.KeyDown:Connect(function(KEY)
				if KEY == 'e' then
					FloatValue = FloatValue + 1.5
				end
			end)
...
function deleteGuisAtPos()
	pcall(function()
		local guisAtPosition = PlayerGui:GetGuiObjectsAtPosition(PHMouse.X, PHMouse.Y)
		for _, gui in pairs(guisAtPosition) do
...
addcmd('hideph',{},function(args, speaker)
	isHidden = true
	...
	minimizeNum = 0
	minimizeHolder()
	if not (args[1] and tostring(args[1]) == 'nonotify') then notify('PH Hidden','You can press the prefix key to access the command bar') end
end)

addcmd('showph',{'unhideph'},function(args, speaker)
	isHidden = false
	minimizeNum = -20
	if wasStayOpen then
		maximizeHolder()
...
addcmd('hovername',{},function(args, speaker)
	...
	nbUpdateFunc = PHMouse.Move:Connect(updateNameBox)
end)
...
addcmd("addallplugins", {"loadallplugins"}, function(args, speaker)
	...
	for _, filePath in ipairs(listfiles("")) do
		local fileName = filePath:match("([^/\\]+%.ph)$")

		if fileName and
			fileName:lower() ~= "ph_fe.ph" and
...
task.spawn(function()
	...
	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify("Outdated", "Get the new version at Pornhub.com")
		end
